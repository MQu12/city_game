...
namespace city_game
{
    class build_button : side_menu_button
    {

        public build_button(int x, int y)
        {
        ...
        public override void Update(float mouse_x, float mouse_y)
        {
            ...
            if (mouse_over(mouse_x, mouse_y))
            {
                ...
                if (Mouse.GetState().LeftButton == ButtonState.Pressed)
                {
                    ...
                    grid.get_selected_tile().set_state(tile.states.concrete);
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(font, "Build here", new Vector2(x_pos + 10, y_pos), Color.Black);
            if (is_mouse_over)
            {
